...
from excel.SheetHelper import SheetHelper as sh
from excel.model.BorderCoord import BorderCoord as bc
from excel.model.FontCoord import FontCoord as fc
from excel.model.AlignmentCoord import AlignmentCoord as ac
from excel.model.Coord import Coord
...
class SubjectsSheet:
    ...
    def create_students(self, start_row, start_col):
        ...
        Coord([self.last_row + 1, start_col], [self.last_row + 1, start_col + 1], title="Подпись преподавателя",
    ...
    def create_subjects(self, start_row, start_col):
        ...
        row = start_row + 3
        self.create_subjects_subjects(row, col)
        ...
        for week in self.schedule:
            for day_week in range(1, 8):
                ...
                if day != -1:
                    ...
                    border_subjects = bc.get_border(top=bc.BOLD)
                    ...
                    for lesson in lessons:
                        if lesson == last_lesson:
                            ...
                            border_subjects = bc.get_border(top=bc.BOLD, right=bc.MEDIUM)
    ...
    def create_subjects_subjects(self, start_row, start_col):
        """Создание записи с оценками"""
        print("Создание записи с оценками")
        row = start_row
        col = start_col
